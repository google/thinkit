...
#ifndef THINKIT_THINKIT_TEST_ENVIRONMENT_H_
#define THINKIT_THINKIT_TEST_ENVIRONMENT_H_
...
class TestEnvironment {
 public:
  ...
  virtual void RecordMetrics(const thinkit::MetricGroup& metric_group) {}

  // Save the logs from the switch with the specified prefix.
  virtual void SaveSwitchLogs(absl::string_view prefix) {}
};

}  // namespace thinkit

#endif  // THINKIT_THINKIT_TEST_ENVIRONMENT_H_
