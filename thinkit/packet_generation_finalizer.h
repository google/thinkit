...
#ifndef THINKIT_THINKIT_PACKET_GENERATION_FINALIZER_H_
#define THINKIT_THINKIT_PACKET_GENERATION_FINALIZER_H_
...
#endif  // THINKIT_THINKIT_PACKET_GENERATION_FINALIZER_H_
